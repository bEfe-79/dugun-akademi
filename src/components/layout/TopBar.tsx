      ...
      >
        ...
        <div style={{ padding: "16px 20px", borderTop: "0.5px solid #e2e8f0" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <button onClick={logout}
              style={{ flexShrink: 0, color: "#ef4444", fontSize: 13, background: "none", border: "0.5px solid #fecaca", borderRadius: 8, cursor: "pointer", padding: "6px 10px" }}>
              Çıkış
            </button>
          </div>
        </div>
