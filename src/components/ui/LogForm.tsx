      ...
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="time" name="logTime" defaultValue={defaultTime} required
              style={{ width: "100%", padding: "10px 14px", borderRadius: 10, border: "1px solid #e2e8f0", fontSize: 14, color: "#1e293b", backgroundColor: "#fff", outline: "none" }} />
          </div>
          <div>
            <label className="label">Aktivite Türü</label>
            <select name="activity" defaultValue="call"
              style={{ width: "100%", padding: "10px 14px", borderRadius: 10, border: "1px solid #e2e8f0", fontSize: 14, color: "#1e293b", backgroundColor: "#fff", outline: "none" }}>
        ...
        <div>
          ...
          <textarea name="logContent" rows={3} required
            placeholder="Bugün ne yaptınız? Müşteri adı, görüşme detayı, sonuç…"
            style={{ width: "100%", padding: "10px 14px", borderRadius: 10, border: "1px solid #e2e8f0", fontSize: 14, color: "#1e293b", backgroundColor: "#fff", outline: "none", resize: "none", fontFamily: "inherit" }} />
        </div>
