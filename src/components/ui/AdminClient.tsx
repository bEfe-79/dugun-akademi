          ...
          <div className="card space-y-4">
            <div className="flex flex-wrap gap-3 items-end">
              ...
              <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
                <button onClick={exportCSV} className="btn-ghost" style={{ fontSize: 13 }}>⬇ CSV</button>
                <button onClick={exportExcel} className="btn-primary" style={{ fontSize: 13 }}>⬇ Excel</button>
              </div>
            </div>
            <div>
              <label style={{ display: "block", fontSize: 11, fontWeight: 700, color: "#64748b", textTransform: "uppercase" as const, letterSpacing: "0.08em", marginBottom: 8 }}>Aktivite Filtresi (çoklu seçim)</label>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
                ...
                <tbody>
                  {filteredLogs.length === 0 ? (
                    ...
                    return (
                      <tr key={log.id}
                        style={{ borderBottom: "1px solid #f1f5f9", backgroundColor: isHov ? HOVER_COLOR : "#ffffff", transition: "background-color 0.15s" }}
