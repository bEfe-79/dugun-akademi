...
import SchoolManager from "@/components/ui/SchoolManager";
      ...
      <div style={{ display: "flex", backgroundColor: "#f1f5f9", border: "1px solid #e2e8f0", borderRadius: 12, padding: 4, gap: 4 }}>
        {TABS.map(t => (
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            fontSize: "clamp(11px,2.5vw,13px)", fontWeight: 500, cursor: "pointer",
            border: "none", transition: "all 0.15s", textAlign: "center", whiteSpace: "nowrap",
